...
export default function AddTask({ onsubmit, children }) {
  return (
    ...
    >
      <input
        className="bg-light-gray bg-gray-50 border px-2 border-gray-300 text-gray-900 text-xs sm:w-56 md:w-96 lg:p-5 lg:text-xl xl:p-5 rounded-md focus:ring-blue-500 focus:border-blue-500 block w-44 h-8 lg:w-128  "
        type="text"
        maxLength="600"
        minLength="10"
